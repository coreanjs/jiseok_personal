...
- How to see the structure of XML files in R? using `XML`, `XML2` libraries or `rgacm` library

- What are the parameters we need to focus on? in dac scenario analysis I just selected the `emissCO2BySector` and `emissCO2BySectorNoBio`. What else should I consider?
