...
### Import NZ2050
dac_cstorage<- gcamextractor::readgcam(gcamdatabase = "E:/gcam-v7.0-Windows-Release-Package/output/231018_dac_revert",
...
modified<- data.frame(
 ...
 revert<- data.frame(
  stringsAsFactors = FALSE,
       check.names = FALSE,
           scenario = c("revert to South Korea",
                        "revert to South Korea","revert to South Korea",
                        "Same as Japan","Same as Japan","Same as Japan"),
               tech = c("hightemp DAC NG",
                        "hightemp DAC elec","lowtemp DAC heatpump","hightemp DAC NG",
                        "hightemp DAC elec","lowtemp DAC heatpump"),
            `1990` = c(0L, 0L, 0L, 0L, 0L, 0L),
            `2005` = c(0L, 0L, 0L, 0L, 0L, 0L),
            `2010` = c(0L, 0L, 0L, 0L, 0L, 0L),
            `2015` = c(0L, 0L, 0L, 0L, 0L, 0L),
            `2020` = c(0L, 0L, 0L, 0L, 0L, 0L),
             `2025` = c(0.000000000757,0,0,
                        0.00000874,0.0000000213,0.0000000197),
             `2030` = c(0.000000022,0.00000000103,
                        0.00000000175,0.000148,0.000000657,0.00000112),
             `2035` = c(0.000000461,0.000000029,
                        0.0000000921,0.001601127,0.0000106,0.0000328),
             `2040` = c(0.0000578,0.00000479,
                        0.0000289,0.023851903,0.000247,0.001453792),
             `2045` = c(0.007554021,0.000827,
                        0.009456294,0.55621698,0.009637283,0.100185438),
             `2050` = c(0.057490062,0.007410889,
                        0.165063522,2.31941894,0.060872303,1.070062261),
             `2055` = c(0.00137389,0.0000948,
                        0.00179064,0.010405613,0.000388,0.90941605),
             `2060` = c(0.000734,0.0000579,0.000978,
                        0.005652524,0.000246,0.003822715),
             `2065` = c(0.000611,0.0000589,0.000877,
                        0.004341093,0.000232,0.003256573),
             `2070` = c(0.00072,0.0000905,
                        0.00115583,0.004713845,0.000321,0.004023647),
             `2075` = c(0.000936,0.000133,
                        0.00158202,0.004787935,0.000371,0.004399895),
             `2080` = c(0.00125007,0.000177,
                        0.00212805,0.004187022,0.000326,0.003940202),
             `2085` = c(0.00166425,0.000228,
                        0.002788301,0.00561885,0.000428,0.005364639),
             `2090` = c(0.00169686,0.00019,
                        0.00260104,0.005533537,0.000357,0.004976206),
             `2095` = c(0.0014063,0.000129,
                        0.00201245,0.004705162,0.00027,0.004140668),
             `2100` = c(0.00125741,0.0000994,
                        0.00170452,0.003960951,0.000213,0.003456565)
 ) %>% 
     pivot_longer(-c('scenario', 'tech'), names_to="year", values_to = "MTC") %>% 
     mutate(year = as.numeric(year))
